...
<template>
  <div class="p-4 bg-gray-800 w-64 flex flex-col text-white" v-if="appStore.isSidebarVisible">
    <ul class="overflow-auto">
      <li class="mb-2">
        <a href="#" class="hover:text-blue-400 text-white font-bold" @click="chatStore.setCurrentChatId(null)">New chat</a>
      </li>
      <li v-for="chat in chatStore.chats"
        ...
        <div class="truncate">
          <a href="#"
             class="hover:text-blue-400 text-white"
